...
//       const sqlUpdate = `
//         UPDATE EmployeeRegistration
//         SET hiringFor = ?, companyName = ?, industry = ?, employeeCount = ?, designation = ?, pincode = ?, address = ?
//         WHERE user_id = ?
//       `;
//       await query(sqlUpdate, [
//         hiringFor,
//         companyName,
//         industry,
//         employeeCount || null, // Allow NULL for optional fields
//         designation,
//         pincode,
//         address,
//         user_id,
...
//       console.log("Inserting new employee registration...");
//       const sqlInsert = `
//         INSERT INTO EmployeeRegistration (user_id, hiringFor, companyName, industry, employeeCount, designation, pincode, address)
//         VALUES (?, ?, ?, ?, ?, ?, ?, ?)
//       `;
//       await query(sqlInsert, [
//         user_id,
...
// /**
//  * 📌 Get Employee Registration by User ID
//  */
// router.get("/register-employee/:user_id", async (req, res) => {
//   const { user_id } = req.params;
...
//   try {
//     const sql = "SELECT * FROM EmployeeRegistration WHERE user_id = ?";
//     const results = await query(sql, [user_id]);

//     if (results.length > 0) {
//       return res.status(200).json({
//         status: "success",
//         message: "Employee registration data fetched successfully.",
//         data: results[0], // Return the first record
//       });
//     } else {
//       return res.status(200).json({
//         status: "success",
//         message: "No employee registration found.",
//         data: null,
//       });
//     }
//   } catch (error) {
